// $ANTLR 3.5 E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g 2013-04-17 18:58:34
...
public class EvaluatorWalker extends TreeParser {
	...
	@Override public String getGrammarFileName() { return "E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g"; }
	...
	// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:19:1: evaluator returns [boolean result] : ( assignment )* e= expression EOF ;
	public final boolean evaluator() throws RecognitionException {
		...
		try {
			// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:20:2: ( ( assignment )* e= expression EOF )
			// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:20:4: ( assignment )* e= expression EOF
			{
			// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:20:4: ( assignment )*
			loop1:
			while (true) {
				int alt1=2;
	...
	// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:23:1: assignment : ^( '=' IDENT e= expression ) ;
	public final void assignment() throws RecognitionException {
		CommonTree IDENT1=null;
		boolean e =false;

		try {
			// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:24:2: ( ^( '=' IDENT e= expression ) )
			// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:24:4: ^( '=' IDENT e= expression )
			{
	...
	// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:28:1: expression returns [boolean result] : ( ^( '&&' op1= expression op2= expression ) | ^( '||' op1= expression op2= expression ) | ^( NEGATION e= expression ) | IDENT | BOOL );
	public final boolean expression() throws RecognitionException {
		...
		try {
			// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:29:2: ( ^( '&&' op1= expression op2= expression ) | ^( '||' op1= expression op2= expression ) | ^( NEGATION e= expression ) | IDENT | BOOL )
			int alt2=5;
			switch ( input.LA(1) ) {
			case 11:
				{
			...
			switch (alt2) {
				case 1 :
					// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:29:4: ^( '&&' op1= expression op2= expression )
					{
					...
					break;
				case 2 :
					// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:30:4: ^( '||' op1= expression op2= expression )
					{
					...
					break;
				case 3 :
					// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:31:4: ^( NEGATION e= expression )
					{
					...
					break;
				case 4 :
					// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:32:4: IDENT
					{
					...
					break;
				case 5 :
					// E:\\peter\\github\\TT\\LogicalExpressions\\src\\columbia\\plt\\tt\\EvaluatorWalker.g:33:4: BOOL
					{
